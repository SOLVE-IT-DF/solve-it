...
def main():
    ...
    lines.append("      description: A short summary of why this reference is relevant (max 280 characters, e.g. Describes the forensic analysis technique used to recover deleted files from NTFS volumes).")
    lines.append("    validations:")
    lines.append("      required: true")
