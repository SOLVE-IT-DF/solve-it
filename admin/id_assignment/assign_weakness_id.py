...
def main():
    ...
    revised_body = revised_body.replace(
        "The next step is for a reviewer to check this submission. Once approved, the weakness will be assigned an ID and the reviewer will advise on the best route to add it to the knowledge base.",
        f"Weakness ID **{weakness_id}** has been assigned. A reviewer will now advise on the best route to add it to the knowledge base.",
    )
